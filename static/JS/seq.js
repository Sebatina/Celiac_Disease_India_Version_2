...
async function filterTable() {
  ...
  const response = await fetch(
    `static/PHP/fetch_seq.php?page=${currentPage}&search=${searchText}`
  );
...
function convertToCSV(rows) {
  const header = ["S.No", "PDB ID", "Macromolecule Name", "Source Organism", "Experimental Method", "Chain ID","Sequence"];
